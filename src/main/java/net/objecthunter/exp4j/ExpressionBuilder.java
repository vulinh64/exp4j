...
/**
 * Factory class for {@link Expression} instances. This class is the main API entrypoint. Users
 * should create new {@link Expression} instances using this factory class.
 */
public class ExpressionBuilder {
  ...
  /**
   * Add a {@link net.objecthunter.exp4j.function.Function} implementation available for use in the
   * expression
   *
   * @param function the custom {@link net.objecthunter.exp4j.function.Function} implementation that
   *     should be available for use in the expression.
  ...
  /**
   * Add multiple {@link net.objecthunter.exp4j.function.Function} implementations available for use
   * in the expression
   *
   ...
   * in the expression
   *
   * @param functions A {@link java.util.List} of custom {@link
   *     net.objecthunter.exp4j.function.Function} implementations
   * @return the ExpressionBuilder instance
   */
  ...
  /**
   * Add an {@link net.objecthunter.exp4j.operator.Operator} which should be available for use in
   * the expression
   *
  ...
  /**
   * Add multiple {@link net.objecthunter.exp4j.operator.Operator} implementations which should be
   * available for use in the expression
   *
   * @param operators the set of custom {@link net.objecthunter.exp4j.operator.Operator}
   ...
   * available for use in the expression
   *
   * @param operators the {@link java.util.List} of custom {@link
   *     net.objecthunter.exp4j.operator.Operator} implementations to add
   * @return the ExpressionBuilder instance
   */
    ...
    for (String v : variableNames) {
      if (Functions.getBuiltInFunction(v) != null || userFunctions.containsKey(v)) {
        throw new IllegalArgumentException(
            String.format("A variable can not have the same name as a function [%s]", v));
      }
    }
